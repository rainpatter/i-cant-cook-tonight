...
router.post("/ingredients/find", (req, res) => {
  ...
  fetch(
    `https://api.spoonacular.com/recipes/complexSearch?includeIngredients=${ingredientsString}&number=30&apiKey=${apiKey}&addRecipeInformation=true&addRecipeInstructions=true&sort=min-missing-ingredients&fillIngredients=true`
  )
    .then((res) => res.json())
