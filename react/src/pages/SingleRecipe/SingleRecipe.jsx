...
export default function SingleRecipe({currentRecipe, user, userId, setShowingRecipe}) {
...
<CloseButton size="xl" onClick={handleGoBack}></CloseButton>
          ...
          <div className="user-features">
            {user ?<Button variant="light" color="orange" size="lg" radius="md" onClick={handleClick}>save to recipes</Button> : ""}
          </div>
        </div>
    )
}